    ...
    let matches = App::new("screeps-rs")
        ...
        .arg(clap::Arg::with_name("debug-modules")
            ...
            .long_help("Enables verbose debug logging for an individual rust module or path.\n\
                For example, `--debug screeps_rs::app::ui` will enable verbose logging for UI related code.\n\
                \n\
                ...
                - screeps_api           HTTP networking, websocket networking and result parsing\n\
